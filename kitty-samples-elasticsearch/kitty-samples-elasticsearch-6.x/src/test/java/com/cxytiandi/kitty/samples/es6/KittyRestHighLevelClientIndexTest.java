...
public class KittyRestHighLevelClientIndexTest {
    ...
    public void testIndex() {
        ...
        IndexResponse indexResponse = kittyRestHighLevelClient.index(EsConstant.ARTICLE_INDEX, EsConstant.DEFAULT_TYPE, articleDocument);
    ...
    public void testIndex2() {
        ArticleDocument articleDocument = buildArticleDocument();
        IndexResponse indexResponse = kittyRestHighLevelClient.index(EsConstant.ARTICLE_INDEX, EsConstant.DEFAULT_TYPE, articleDocument, articleDocument.getId().toString());
        Assert.assertTrue(StringUtils.hasText(indexResponse.getId()));
    }
    ...
    public void testIndex3() {
        ...
        indexRequest.index(EsConstant.ARTICLE_INDEX);
